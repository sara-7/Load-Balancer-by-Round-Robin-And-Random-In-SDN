...
class iplb (object):
  ...
  def __init__ (self, connection, service_ip, servers = []):
    ...
    self.mac = EthAddr("00:00:00:11:22:33")   #تعديييل
  ...
  def _pick_server (self, key, inport):
    ...
    """
    global selected_server      #تعدييييل
...
def launch (ip, servers):
  ...
  from misc.arp_responder import launch as arp_launch       #تعديييل
  arp_launch(eat_packets=False,**{str(ip):True})
  import logging
  logging.getLogger("misc.arp_responder").setLevel(logging.WARN)   #تعدييي
